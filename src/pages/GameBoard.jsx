...
function GameBoard() {
  const { gameObject, username, Selection, ResetGame, CloseConnection } = usePeerContext();
            ...
            isGameOver && (
              <>
                      ...
                      <div className="text-center py-3 text-3xl">
                        {
                          winnerID ?
                            ...
                            :
                            <>
                              <p className="font-medium text-white">It's a Draw!</p>
                            </>
                        }
                      </div>
                    </div>
                ...
                <div className="mt-5 flex flex-col gap-y-3 relative
                  ...
                  after:containt-[''] after:absolute after:block after:h-14 after:w-3 after:bg-indigo-400 after:rounded-lg after:right-8 after:-top-10 after:shadow-[0px_0.3rem] after:shadow-blue-950/90
                ">
                  <button className="py-3 w-full bg-pink-500 rounded-lg shadow-[0px_0.35rem] shadow-pink-900 cursor-pointer active:shadow-none active:translate-y-2 transition-all" onClick={() => ResetGame()}>
                ...
                <div className="mt-5 flex flex-col gap-y-3 relative
                  ...
                  after:containt-[''] after:absolute after:block after:h-14 after:w-3 after:bg-indigo-400 after:rounded-lg after:right-8 after:-top-10 after:shadow-[0px_0.3rem] after:shadow-blue-950/90
                ">
                  <button className="py-3 w-full bg-indigo-900 rounded-lg shadow-[0px_0.4rem] shadow-indigo-950 cursor-pointer active:shadow-none active:translate-y-2 transition-all" onClick={() => CloseConnection()}>
                    <span className="font-semibold text-3xl text-white">Close</span>
                  </button>
                </div>
              </>
            )
